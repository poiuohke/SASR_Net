...
class FALoss(torch.nn.Module):
    ...
    def forward(self,feature1,feature2):
        ...
        m_batchsize, C, height, width, depth = feature1.size()
        feature1 = feature1.view(m_batchsize, -1, width*height*depth)  #[N,C,W*H*D]
        ...
        mat1 = torch.bmm(feature1.permute(0,2,1),feature1) #[N,W*H*D,W*H*D]

        m_batchsize, C, height, width, depth = feature2.size()
        feature2 = feature2.view(m_batchsize, -1, width*height*depth)  #[N,C,W*H*D]
        ...
        mat2 = torch.bmm(feature2.permute(0,2,1),feature2) #[N,W*H*D,W*H*D]

        L1norm=torch.norm(mat2-mat1,1)

        return L1norm/((height*width*depth)**2)
